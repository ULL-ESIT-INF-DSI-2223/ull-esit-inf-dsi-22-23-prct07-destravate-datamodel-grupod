...
export class Rutas{
    ...
    constructor(id: number, nombre: string, cordenadas_incio: coordenadas, 
        cordenadas_fin: coordenadas, longitud: number, desnivel: number, 
        usuarios_ya_realizados: number[], tipo_ruta: string,  
        calificacion: number){
        if (Rutas.ids_rutas.includes(id)){

...
export class App {
      ...
      .prompt([
        {
          type: "list",
          name: "usuarios",
          message: "¿Que usuario quieres modificar?",
          choices: this.usuarios.getNombres(),
        },
      ])
      .then((answers) => {
        const usuario: Usuario = this.usuarios.getUsuario(answers.usuarios);
        inquirer
          .prompt([
            {
              type: "list",
          ...
          .then((answers) => {
            switch (answers.modificar) {
              case "Nombre":
                this.modificarNombreUsuario(usuario);
                break;
            }
          });
      });
  ...
  modificarNombreUsuario(usuario: Usuario): void {
    console.clear();
    inquirer
      .prompt([
        {
